    ...
    <div class="container pt-5 mx-auto">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <ul class="nav nav-tabs mb-3" id="ex1" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <a data-mdb-tab-init class="nav-link active" id="ex1-tab-3" href="{{route('staff.absensi-index')}}" role="tab"
                ...
                <div class="d-flex my-5">
                    <div class="card" style="width: 100%;">
                        <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($data as $dataAbsensi)
                                        <tr>
                                            ...
                                            <td class="text-center">{{ $dataAbsensi->total_masuk }}</td>
                            ...
                            <div>
                                <a class="btn btn-outline-danger mt-5" href="{{ route('export.pdf') }}" style="pointer-events: none; opacity: 0.5;">Print PDF</a>
                            </div>
                        </div>
                    </div>
                </div>
